...
class BackToMain(QtGui.QWidget):
    ...
    def Show_(self):
        if self.obj_MainWidget.Widget.isVisible():
            self.obj_MainWidget.Widget.hide()    
        self.Widget.show()
...
class MainWidget(QtGui.QMainWindow):
    def __init__(self):
        ...
        self.Widget.Sp_1_Di.setStyleSheet("background:rgb(255,255,224)")
        self.Widget.Sp_1_T.setStyleSheet("background:rgb(255,255,224)")
        self.Widget.Sp_1_Do.setStyleSheet("background:rgb(255,255,224)")
        
        self.Widget.Cb_1_GtFc.clicked.connect(self.GtFc_onClick)
        self.Widget.Cb_2_GtFc.clicked.connect(self.GtFc_onClick)
        self.Widget.Cb_3_GtFc.clicked.connect(self.GtFc_onClick)                                
        ...
        self.Widget.Sp_2_D1.valueChanged.connect(lambda: self.value_insert("Sp_2_D1"))
        self.Widget.Sp_2_D2.valueChanged.connect(lambda: self.value_insert("Sp_2_D2"))
        self.Widget.Sp_2_D3.valueChanged.connect(lambda: self.value_insert("Sp_2_D3"))
        self.Widget.Sp_2_D4.valueChanged.connect(lambda: self.value_insert("Sp_2_D4"))
        self.Widget.Sp_2_D5.valueChanged.connect(lambda: self.value_insert("Sp_2_D5"))
        self.Widget.Sp_2_D6.valueChanged.connect(lambda: self.value_insert("Sp_2_D6"))
        self.Widget.Sp_2_D7.valueChanged.connect(lambda: self.value_insert("Sp_2_D7"))
        self.Widget.Sp_2_D8.valueChanged.connect(lambda: self.value_insert("Sp_2_D8"))
        self.Widget.Sp_2_D9.valueChanged.connect(lambda: self.value_insert("Sp_2_D9"))

        self.Widget.Sp_2_D1.setStyleSheet("background:rgb(255,255,224)")
        self.Widget.Sp_2_D2.setStyleSheet("background:rgb(255,255,224)")
        self.Widget.Sp_2_D3.setStyleSheet("background:rgb(255,255,224)")
        self.Widget.Sp_2_D4.setStyleSheet("background:rgb(255,255,224)")
        self.Widget.Sp_2_D5.setStyleSheet("background:rgb(255,255,224)")
        self.Widget.Sp_2_D6.setStyleSheet("background:rgb(255,255,224)")
        self.Widget.Sp_2_D7.setStyleSheet("background:rgb(255,255,224)")
        self.Widget.Sp_2_D8.setStyleSheet("background:rgb(255,255,224)")
        self.Widget.Sp_2_D9.setStyleSheet("background:rgb(255,255,224)")      
...
#        self.Widget.Sp_1_Di.setStyleSheet("background-color: red") ("background:QColor(255,255,224)")
    def Test(self):
        print('Di  ',self.Widget.Sp_1_Di.font())
        print('Do  ',self.Widget.Sp_1_Do.font())
        self.Widget.Sp_1_Di.setStyleSheet("")
        self.Widget.Sp_1_Di.setFont(self.Font)
    ...
    def value_insert(self, DblSpb):
        #print(DblSpb, getattr(self.Widget,DblSpb).value() ,self.dim_values['Gr'])
        if self.do_events:
...
#self.Widget.Sp_2_D1.setStyleSheet("background:rgb(255,255,224)") lightgreen 90 EE 90 144,238,144 ("background-color: red")

    def corr_Gr1(self, DblSpb):
        self.do_events = False
        #print('corr_Gr1', DblSpb)
        if DblSpb == 'Sp_2_D3' and self.Widget.Sp_2_D3.value() > 0: 
            print('corr: Sp_2_D3')
            self.Widget.Sp_2_D4.setValue(self.Widget.Sp_2_D3.value() + self.Widget.Sp_2_D8.value())
            self.dim_values['Sp_2_D4'] = self.Widget.Sp_2_D4.value()

        if DblSpb == 'Sp_2_D8' and self.Widget.Sp_2_D8.value() > 0:
            self.Widget.Sp_2_D9.setValue(self.Widget.Sp_2_D8.value()*2)
            self.dim_values['Sp_2_D9'] = self.Widget.Sp_2_D9.value()
            print(self.Widget.Sp_2_D8.font())
            print(self.Font.Bold)
            self.Widget.Sp_2_D8.setStyleSheet("background:rgb(144,238,144)")
            self.Widget.Sp_2_D9.setStyleSheet("background:rgb(144,238,144)")
            self.Widget.Sp_2_D8.setFont(self.Font) #setWeight(QFont::Bold)
            self.Widget.Sp_2_D8.Weight.setBold(True)
            print(type(self.Font))
            self.Widget.Sp_2_D9.setFont(self.Font)            

        if DblSpb == 'Sp_2_D9' and self.Widget.Sp_2_D9.value() > 0:
            self.Widget.Sp_2_D8.setValue(self.Widget.Sp_2_D9.value()/2)
            self.dim_values['Sp_2_D8'] = self.Widget.Sp_2_D8.value()
            self.Widget.Sp_2_D8.setStyleSheet("background:rgb(144,238,144)")
            self.Widget.Sp_2_D9.setStyleSheet("background:rgb(144,238,144)")

        self.Widget.Sp_2_D3.setValue(self.Widget.Sp_2_D4.value() + self.Widget.Sp_2_D9.value())
        self.dim_values['Sp_2_D3'] = self.Widget.Sp_2_D3.value()
